---
layout: default
title: Verbale_25-03-13_v1.0
permalink: docs/PB/verbale_esterno/verbale_25-03-13.html
---

<h2>Download</h2>

<a href="https://raw.githubusercontent.com/code7crusaders/docs/develop/pdf/3_PB/verbali_esterni/firmati/verbale_25-03-13_v1.0_firm.pdf" class="github-button" download>
...
## Ordine del Giorno
- Discussione architettura da utilizzare.

## Verbale 

### Discussione sull'architettura da adottare
**Sintesi**: Durante il nostro confronto, abbiamo approfondito alcuni dubbi riguardanti la scelta dell’architettura più adatta per il progetto. In particolare, ci siamo soffermati sull’analisi dei vantaggi e degli svantaggi di due approcci distinti: l’architettura monolitica e quella basata su microservizi.
...
## Conclusioni
**Prossimi passi:** Definire una data per l’incontro in azieda in modo da mostrare lo stato di avanzamento del progetto ed eventuale MVP nel caso fosse completo.