---
layout: default
title: Verbale_24-12-07_v1.0
permalink: docs/RTB/verbali_interni/verbale_24-12-07_v1.0.html
---

<h2>Download</h2>

<a href="https://raw.githubusercontent.com/code7crusaders/docs/develop/pdf/2_RTB/verbali_interni/verbale_24-12-07_v1.0.pdf" class="github-button" download>
    <span class="github-icon">🐙</span> 
    Scarica PDF da GitHub
</a>

# Riunione Settimanale 07/12/2024
...
Filippo Rizzolo | Progettista | Assente

# Ordine del Giorno
- Discussione LLM da utilizzare
- Inizio piano di qualifica
- Chiamata con l'azienda
...
#### Inizio piano di qualifica e continuazione vari documenti
...
- Contattare l'azienda per decidere la tipologia di LLM da utilizzare.
- Contattare il Professor Cardin per analizzare la correttezza dei casi d'uso
- Continuare a lavorare sulle norme di progetto e sul piano di progetto, aggiungendo ulteriori dettagli
- Iniziare il piano di qualifica
- Definire l'architettura di sistema migliore.

La prossima riunione è pianificata per il **13/12/24**, con l'obiettivo di analizzare i progressi ottenuti e pianificare i prossimi passi
